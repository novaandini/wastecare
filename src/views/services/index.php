...
<body>
    ...
    <div class="bg-gray-300 rounded-3xl m-4 px-16 py-56 flex flex-col justify-center mb-16">
        <h1 class="md:text-8xl lg:text-9xl text-4xl font-bold text-center mb-4">Services</h1>
        ...
        <a href="" class="m-auto rounded-full border-black border-2 py-2 px-8 md:text-xl text-base font-bold">Lihat Layanan</a>
    </div>
