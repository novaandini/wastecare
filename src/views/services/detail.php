...
<body>
    ...
    <div class="rounded-3xl mx-12 mt-64 flex mb-16 gap-16">
        ...
        <div class="w-2/3">
            ...
            <p class="text-lg mb-8">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo, aliquid? Perspiciatis nulla eius dolor asperiores repellat velit nam ratione natus? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo, aliquid? Perspiciatis nulla eius dolor asperiores repellat velit nam ratione natus? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo, aliquid?</p>
            <div class="flex items-center justify-between">
                <h2 class="text-xl">4.1/5</h2>
                <a href="" class="rounded-full border-black border-2 py-2 px-8 text-base font-bold">Lihat Layanan</a>
            </div>
        </div>
    </div>
    <div class="w-6xl m-auto mb-16">
        <div class="w-4xl m-auto flex flex-col justify-center text-center mb-8">
            ...
            <div class="flex justify-content-between overflow-x-auto no-scrollbar">
        ...
        <div class="flex flex-wrap justify-content-between overflow-x-auto gap-4">
            <div class="bg-gray-300 basis-[32%] h-96 p-8 rounded-2xl flex flex-col justify-between">
                <div class="">
                    <h3 class="text-xl font-bold">Jasa Pengangkutan dan Pengelolaan Sampah di Bali</h3>
                    <p class="line-clamp-3">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo, aliquid? Perspiciatis nulla eius dolor asperiores repellat velit nam...</p>
                </div>
                <div class="bottom-0">
                    <div class="flex w-full justify-between mb-2 text-xl">
                        <h4 class="font-bold">Rp3000/hari</h4>
                        <h4 class="">4.1/5</h4>
                    </div>
                    <a href="" class="block m-auto rounded-full border-black border-2 py-2 px-8 md:text-xl text-base font-bold text-center">Pesan</a>
                </div>
            </div>
            <div class="bg-gray-300 basis-[32%] h-96 p-8 rounded-2xl flex flex-col justify-between">
                <div class="">
